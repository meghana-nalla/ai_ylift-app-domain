...
class SpringIntoRewardsSidePanel extends StatelessWidget {
  const SpringIntoRewardsSidePanel({super.key});
  ...
  Widget build(BuildContext context) {
    return Obx(() {
      ...
      return PromotionSidePanel(
        ...
        description: 'Get coupon codes for each qualifying purchase.',
        children: [
          Padding(
            padding: _padding,
            child: Text(
