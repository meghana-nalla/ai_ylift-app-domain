...
class MyVideoLibrarySection extends StatefulWidget {
  const MyVideoLibrarySection({super.key});

  @override
  State<MyVideoLibrarySection> createState() => _MyVideoLibrarySectionState();
}

class _MyVideoLibrarySectionState extends State<MyVideoLibrarySection> {
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      ...
      children: [
        ...
        const Text(
          'Your purchased content will show up here. If you just purchased a new content, please refresh the page.',
        ),
