...
class MobileSignupPage extends StatefulWidget {
  ...
  @override
  State<MobileSignupPage> createState() => _SignupPageState();
}

class _SignupPageState extends State<MobileSignupPage> {
                  ...
                  child: Column(
                    ...
                    children: [
                      Text(
                        ...
                        style: textTheme.headlineSmall?.copyWith(fontSize: 20), // Smaller font
                        textAlign: TextAlign.center,
                      ),
                      const SizedBox(height: 8),
                      SizedBox(child: const AlreadyHaveAnAccountText()),
    ...
    return RichText(
      text: TextSpan(
        style: const TextStyle(
          ...
          color: Colors.black, // set color to avoid inheriting null
        ),
        children: [
