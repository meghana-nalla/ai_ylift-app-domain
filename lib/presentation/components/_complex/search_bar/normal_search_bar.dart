...
class SearchBarAdvanced extends StatefulWidget {
  @override
  _SearchBarAdvancedState createState() => _SearchBarAdvancedState();
}

class _SearchBarAdvancedState extends State<SearchBarAdvanced> {
  ...
  void _viewFullResults() {
    controller.enteredSubcategory.value = true; // needed for grid view
    controller.navigateQuickLinkIndex.value = 2;
    controller.vroute.navigateToIndex(7);
  }
  ...
  Widget build(BuildContext context) {
    return Material(
      ...
      child: Column(
        ...
        children: [
          Obx(() => ProductSearchBar(
            onSearch: _handleSearch,
            onChanged: _handleSearchChange,
            previousSearches: controller.previousSearches.value,
          ...
          //             } else {
          //               return QuickLinksNav(controller.quickLinks as List<QuickLinksSimple>);
          //             }
          //           }),
          //           SizedBox(height: 8),
          //         ],
